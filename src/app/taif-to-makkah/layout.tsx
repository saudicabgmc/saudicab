...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Taif to Makkah Taxi – Saudi Cabs GMC', description: 'Scenic mountain descent from Taif to Makkah. Fixed price, 24/7.', url: 'https://saudicabsgmc.com/taif-to-makkah', images: [{ url: 'https://saudicabsgmc.com/fleet/toyota-camry-exterior-front-saudi-cabs-gmc.webp', width: 1200, height: 630, alt: 'Taif to Makkah Taxi – Saudi Cabs GMC' }] },
}
