...
import { MessageCircle, Shield, Clock, Star, Users, MapPin } from 'lucide-react'
import BookingForm from '@/components/BookingForm'
import FAQSection from '@/components/FAQSection'
import { useLang } from '@/contexts/LanguageContext'

const FAQS = [
  { q: { en: 'What is a private driver service in Saudi Arabia?', ar: 'ما هي خدمة السائق الخاص في المملكة؟' }, a: { en: 'A private driver service means a professional driver is assigned exclusively to you for a set number of hours or days. They take you wherever you need, wait for you, and aim for a comfortable, reliable experience throughout.', ar: 'خدمة السائق الخاص تعني تخصيص سائق محترف لك حصرياً لعدد محدد من الساعات أو الأيام. يأخذك أينما تحتاج وينتظرك ويسعى لتقديم تجربة مريحة وموثوقة طوال الوقت.' } },
  ...
  { q: { en: 'Can I use a private driver for business in Jeddah?', ar: 'هل يمكنني استخدام سائق خاص للأعمال في جدة؟' }, a: { en: 'Yes, our private driver service in Jeddah includes a luxury sedan or SUV, a professional driver, and punctual service for meetings, conferences, and airport connections.', ar: 'نعم، خدمة السائق الخاص في جدة تشمل سيداناً فاخراً أو SUV، وسائقاً محترفاً، وخدمة دقيقة للمواعيد للاجتماعات والمؤتمرات ورحلات المطار.' } },
