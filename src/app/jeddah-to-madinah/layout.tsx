...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Jeddah to Madinah Taxi – Saudi Cabs GMC", description: "Direct private cab from Jeddah to Madinah. Fixed price, 24/7.", url: 'https://saudicabsgmc.com/jeddah-to-madinah' },
}
