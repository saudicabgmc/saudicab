...
import { MessageCircle, Star, Shield, CheckCircle, Users, Wind, MapPin, Package, DoorOpen } from 'lucide-react'
...
export default function HyundaiStariaPage() {
  ...
  return (
    <main>
      ...
      <section style={{ padding: '0 0 40px', backgroundColor: 'var(--muted)' }}>
        <div className="container" style={{ textAlign: 'center' }}>
