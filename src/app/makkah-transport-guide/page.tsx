...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'What is the best transport in Makkah?', acceptedAnswer: { '@type': 'Answer', text: 'Private cab is a convenient private transport option in Makkah. Saudi Cabs GMC offers door-to-door service across Makkah, including hotel pickups near Masjid al-Haram. Fixed prices, 24/7 availability.' } },
    ...
    { '@type': 'Question', name: 'Is Uber available in Makkah?', acceptedAnswer: { '@type': 'Answer', text: 'Uber and Careem operate in Makkah but availability is limited during peak Hajj and Umrah seasons. As an alternative, especially for airport transfers and intercity routes, Saudi Cabs GMC offers pre-booked fixed-price private cabs, subject to booking availability, via WhatsApp.' } },
  ...
  return (
    <>
      ...
      <GuidePageTemplate
        ...
        quickAnswer="A convenient private transport option in Makkah is a private cab from Saudi Cabs GMC — door-to-door service with fixed pricing, available 24/7. Book via WhatsApp at +92 309 7811785 for airport transfers, hotel pickups, Ziyarat tours, and intercity routes to Madinah, Jeddah, and Taif."
        keyFacts={[
          { icon: '🕋', label: 'City', value: 'Makkah al-Mukarramah' },
          { icon: '🏙️', label: 'Province', value: 'Makkah Province, KSA' },
          { icon: '✈️', label: 'Main International Airport', value: 'Jeddah KAIA (~90 km)' },
        ...
        faqs={[
          { q: 'What is the best transport in Makkah?', a: 'Private cab is a convenient private transport option in Makkah. Saudi Cabs GMC offers door-to-door service across Makkah with fixed prices and 24/7 availability — including pickups from hotels near Masjid al-Haram.' },
          ...
          { q: 'Is Uber available in Makkah?', a: 'Uber and Careem operate in Makkah but availability is very limited during Hajj and Umrah peak seasons. Saudi Cabs GMC offers pre-booked fixed-price private cabs, subject to booking availability.' },
        ...
        relatedLinks={[
          ...
          { href: '/blog/best-places-makkah-ziyarat', label: 'Best Places for Makkah Ziyarat', tag: 'Makkah Ziyarat Guide' },
        ]}
      >
        ...
        <p style={{ marginBottom: '12px' }}>Saudi Cabs GMC provides a convenient door-to-door private cab service in Makkah. Key facts:</p>
        ...
        <h3 style={{ fontSize: '1.1rem', fontWeight: '800', margin: '24px 0 10px' }}>3. Makkah Public Transport & Mashair Railway</h3>
        <p style={{ marginBottom: '24px' }}>The Mashair Railway operates between Makkah, Arafat, Muzdalifah, and Mina, mainly during Hajj season. Access and arrangements depend on the official Hajj transport system and pilgrim eligibility, and it is extremely crowded during peak times.</p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
            <thead>
              <tr style={{ background: 'var(--primary)', color: 'var(--foreground)' }}>
                <th style={{ padding: '10px 14px', textAlign: 'left', fontWeight: '800', borderRight: '1px solid rgba(0,0,0,0.12)' }}>Route</th>
            ...
            <tbody>
              {[
                ...
                <tr key={i} style={{ background: i % 2 === 0 ? 'white' : 'var(--muted)', borderBottom: '1px solid var(--border)' }}>
                  <td style={{ padding: '10px 14px', fontWeight: '600', borderRight: '1px solid var(--border)' }}>{route}</td>
        ...
        <p style={{ fontSize: '0.82rem', color: 'var(--muted-foreground)', marginTop: '-12px', marginBottom: '24px' }}>
          Travel times are approximate and may vary depending on traffic, route and pickup location.
        </p>
      </GuidePageTemplate>
    </>
  )
