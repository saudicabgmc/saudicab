...
export default function MakkahZiyaratPage() {
  ...
  const waUrl = `https://wa.me/966569487569?text=${encodeURIComponent(isAr ? 'السلام عليكم، أرغب في حجز جولة زيارات مكة' : "Hello, I'd like to book a Makkah Ziyarat tour")}`
