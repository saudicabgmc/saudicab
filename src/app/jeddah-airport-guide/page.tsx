...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'How do I book a taxi from Jeddah Airport to Makkah?', acceptedAnswer: { '@type': 'Answer', text: 'Book via WhatsApp at +92 309 7811785 (Saudi Cabs GMC). The driver meets you at arrivals with a name board. Fixed price, no meter.' } },
  ...
  return (
    <>
      ...
      <GuidePageTemplate
        ...
        quickAnswer="The best way from Jeddah Airport (KAIA) to Makkah is a private taxi with Saudi Cabs GMC — 90 km, ~55 minutes, fixed price. Driver meets you at arrivals with a name board. Book via WhatsApp: +92 309 7811785."
        keyFacts={[
        ...
        faqs={[
          ...
          { q: 'How do I book a taxi from Jeddah Airport to Makkah?', a: 'Book via WhatsApp at +92 309 7811785. Send your flight number, arrival time, and hotel name. The driver will be at arrivals with a name board when you land.' },
